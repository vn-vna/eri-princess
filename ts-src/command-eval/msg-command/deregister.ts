                ...
                try {
                    ...
                    if (!finder) {
                        const eMsg = new MessageEmbed()
                            ...
                            .addField(`Server ${message?.guild?.name} chưa thực hiện đăng kí trước đây!`, `Sử dụng \`register\` để đăng kí nhé ❤️`)
                        ...
                        if (del.ok) {
                            const eMsg = new MessageEmbed()
                                ...
                                .addField(`Yêu cầu từ ${message.author.tag}\nServer ${message.guild?.name} đã huỷ thành công kí trước đó.`, `Xin lỗi vì Eri làm phiền mọi người 😭`)
                            message.reply({ embeds: [eMsg] })
                            message.react('😭')
                        }
                    }
                    ...
                    const eMsg = new MessageEmbed()
                        ...
                        .addField(`Yêu cầu huỷ đăng kí đến từ ${message.guild?.name} xuất hiện lỗi.`, `Vui lòng liên hệ master để báo lỗi nhé 😫`)
                    message.reply({ embeds: [eMsg] })
                }
